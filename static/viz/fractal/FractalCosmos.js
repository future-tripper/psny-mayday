...
const ORIGINAL_SEED = {
    ...
    lines: [
        ...
        "playing slowly. Double-Loss. And Wham!",
        "Blow the man down! (or their faces off)",
        "That's all Folks! (and then some) or else I",
        "Was never born. Red River Valley: a",
        "Cowboy ode? (no, just 1 man 1 phone & 1 woman)",
        "Dear Chris, hello. I'm just now writing",
        "you after a long sleep in a comfortable",
        "chair by the window in the sun, the wood-",
        "en chair painted green: I've been to Boston",
        "and seen Ted, who's blossomed into a regular",
        "Old Master! He made me his delicious eggs. &",
        "The light falls heavy on the morning page.",
        "Some dim frieze playing slowly. His piercing pince-nez."
    ]
};
